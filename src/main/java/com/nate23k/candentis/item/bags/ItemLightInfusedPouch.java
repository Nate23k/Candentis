package com.nate23k.candentis.item.bags;
...
// Set a UUID on the Alchemical Bag, if one doesn't exist already
            ...
            entityPlayer.openGui(Candentis.instance, GUIs.LIGHT_INFUSED_POUCH.ordinal(), entityPlayer.worldObj, (int) entityPlayer.posX, (int) entityPlayer.posY, (int) entityPlayer.posZ);
        }
        return itemStack;
    }
    @Override
