...
public class Reference
{
    ...
    public static final String SERVER_PROXY_CLASS = "com.nate23k.candentis.proxy.ServerProxy";
    public static final String GUI_FACTORY_CLASS = "com.nate23k.candentis.client.gui.GuiFactory";
}
